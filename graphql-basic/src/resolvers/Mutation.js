...
const Mutation = {
  ...
  deletePost(_, args, { db, pubsub }, info) {
    const postIndex = db.posts.findIndex((post) => post.id === args.data.id);
    ...
    db.comments = db.comments.filter(
      (comment) => comment.post === args.data.id
    );
  ...
  deleteComment(_, args, { db, pubsub }, info) {
